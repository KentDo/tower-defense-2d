...
public class TowerInfoPanel : MonoBehaviour
{
    ...
    void UpdateDisplay(Tower t)
    {
        ...
        if (txtLevel)    txtLevel.text    = $"Level: {t.level + 1}";
        ...
        int upgradeCost = t.upgradeCost;
        int sellValue   = Mathf.RoundToInt(t.upgradeCost * t.sellPercent);
